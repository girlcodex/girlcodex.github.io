...
touchOpt = {dragControl: true, shape: 'sphere', textFont: 'Open Sans', imagePadding: 2,textColour: '#ccc', outlineColour: '#0f0', clickToFront:   500, reverse: true, depth: 1, maxSpeed: 0.02,  initial: [0.01,-0.01], zoom: 2, imageRadius: 5, imagePosition: "bottom",  imageMode: "both",  outlineMethod: 'colour', bgOutlineThickness: 2, bgColour: '#111',  bgRadius: 5,  outlineRadius: 5,  fadeIn: 2000,decel: .99,  pinchZoom: true, imageVAlign: "top", centreImage: './img/logo.png'};
tagOpt = touchOpt; 
}else{
mouseOpt = {dragControl: false, shape: 'sphere', textFont: 'Open Sans', imagePadding: 2,textColour: '#ccc', outlineColour: '#0f0', clickToFront:   500, reverse: false, depth: 1, maxSpeed: 0.02,  initial: [0.01,-0.01], zoom: 10, imageRadius: 5, imagePosition: "bottom",  imageMode: "both",  outlineMethod: 'colour', bgOutlineThickness: 2, bgColour: '#111',  bgRadius: 5,  outlineRadius: 5,  fadeIn: 2000,decel: .99,  pinchZoom: true, imageVAlign: "top", centreImage: '../img/logo.png'}
